...
package rubyko.java.rmi.server;
...
public class RMIClassLoader {
    ...
    {
        return rubyko.sun.rmi.server.LoaderHandler.getSecurityContext(loader);
    }
    ...
    private static RMIClassLoaderSpi newDefaultProviderInstance() {
        return new RMIClassLoaderSpi() {
            public Class<?> loadClass(String codebase, String name,
                ...
                throws MalformedURLException, ClassNotFoundException
            {
                return rubyko.sun.rmi.server.LoaderHandler.loadClass(
            ...
            public Class<?> loadProxyClass(String codebase,
                ...
                throws MalformedURLException, ClassNotFoundException
            {
                return rubyko.sun.rmi.server.LoaderHandler.loadProxyClass(
            ...
            {
                return rubyko.sun.rmi.server.LoaderHandler.getClassLoader(codebase);
            }

            public String getClassAnnotation(Class<?> cl) {
                return rubyko.sun.rmi.server.LoaderHandler.getClassAnnotation(cl);
            }
        };
    }
