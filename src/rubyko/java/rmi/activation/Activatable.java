...
package rubyko.java.rmi.activation;
...
import rubyko.sun.rmi.server.ActivatableServerRef;
...
public abstract class Activatable extends RemoteServer {
        ...
        throws UnknownGroupException, ActivationException, RemoteException
    {
        ...
        return rubyko.sun.rmi.server.ActivatableRef.getStub(desc, id);
    }
    ...
    {
        return rubyko.sun.rmi.transport.ObjectTable.unexportObject(obj, force);
    }
