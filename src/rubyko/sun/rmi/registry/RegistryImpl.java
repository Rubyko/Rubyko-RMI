...
package rubyko.sun.rmi.registry;
...
import rubyko.sun.rmi.server.UnicastServerRef2;
 ...
 */
public class RegistryImpl extends rubyko.java.rmi.server.RemoteServer
        implements Registry
{
    ...
    public static void main(String args[])
    {
       ...
       //     System.setSecurityManager(new RMISecurityManager());
        ...
        try {
            ...
            URL[] urls = rubyko.sun.misc.URLClassPath.pathToURLs(envcp);
             ...
             */
            rubyko.sun.rmi.server.LoaderHandler.registerCodebaseLoader(cl);
