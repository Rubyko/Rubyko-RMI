 ...
 * @author   Sheng Liang
 * @author   Bill Shannon
 * @see      rubyko.sun.misc.SignalHandler
 * @since    1.2
 */
public final class Signal {
     ...
     * @see rubyko.sun.misc.Signal#Signal(String name)
     */
     ...
     * @see rubyko.sun.misc.Signal#getName()
     */
     ...
     * @see rubyko.sun.misc.Signal#raise(Signal sig)
     * @see rubyko.sun.misc.SignalHandler
     * @see rubyko.sun.misc.SignalHandler#SIG_DFL
     * @see rubyko.sun.misc.SignalHandler#SIG_IGN
     */
     ...
     *
     * @param sig a signal
     * @see rubyko.sun.misc.Signal#handle(Signal sig, SignalHandler handler)
     */
