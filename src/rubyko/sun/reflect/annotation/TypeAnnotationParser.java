...
import rubyko.sun.misc.JavaLangAccess;
import rubyko.sun.reflect.ConstantPool;
import static rubyko.sun.reflect.annotation.TypeAnnotation.*;
...
public final class TypeAnnotationParser {
    ...
    static TypeAnnotation[] parseAllTypeAnnotations(AnnotatedElement decl) {
        Class<?> container;
        byte[] rawBytes;
        JavaLangAccess javaLangAccess = rubyko.sun.misc.SharedSecrets.getJavaLangAccess();
        if (decl instanceof Class) {
